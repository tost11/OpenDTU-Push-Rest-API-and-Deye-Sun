...
static const byteAssign_t byteAssignment[] = {
        ...
        { TYPE_DC, CH1, FLD_IDC, UNIT_A, 8, 2, 10, false,true, 2 },
        ...
        { TYPE_AC, CH0, FLD_IAC, UNIT_A, 28, 2, 10, false,true, 2 },
        { TYPE_AC, CH0, FLD_PAC, UNIT_W, 22, 4, 10, false,true, 1 },
...
AT_DS_2CH::AT_DS_2CH(uint64_t serial,const String & model) :
...
const std::vector<RegisterMapping> &AT_DS_2CH::getRegisteresToRead() {
