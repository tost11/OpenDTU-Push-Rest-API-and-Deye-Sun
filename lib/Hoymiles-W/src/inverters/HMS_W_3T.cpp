...
static const byteAssign_t byteAssignment[] = {
        ...
        { TYPE_DC, CH1, FLD_UDC, UNIT_V, 44, 2, 10, false,false, 1 },
        { TYPE_DC, CH1, FLD_IDC, UNIT_A, 42, 2, 100, false,false, 2 },
        { TYPE_DC, CH1, FLD_PDC, UNIT_W, 46, 2, 10, false,false, 2 },
        { TYPE_DC, CH1, FLD_YD, UNIT_WH, 48, 4, 1, false,false, 0 },
        { TYPE_DC, CH1, FLD_YT, UNIT_KWH, 50, 4, 1000, false,false, 3 },
        { TYPE_DC, CH1, FLD_IRR, UNIT_PCT, CALC_CH_IRR, CH0, CMD_CALC, false,false, 3 },

        { TYPE_AC, CH2, FLD_UAC, UNIT_V, 2, 2, 10, false,false, 1 },
        { TYPE_AC, CH2, FLD_IAC, UNIT_A, 0, 2, 100, false,false, 2 },
        { TYPE_AC, CH2, FLD_PAC, UNIT_W, 4, 2, 10, false,false, 1 },
        { TYPE_AC, CH2, FLD_Q, UNIT_VAR, 76, 2, 1000, true,false, 1 },
        { TYPE_AC, CH2, FLD_F, UNIT_HZ, 70, 2, 100, false,false, 2 },
        { TYPE_AC, CH2, FLD_PF, UNIT_NONE, 74, 2, 1, true,false, 3 },
...
bool HMS_W_3T::isValidSerial(const uint64_t serial)
{
