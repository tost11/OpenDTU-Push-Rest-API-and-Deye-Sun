...
class HoymilesClass : public BaseInverterHandler<InverterAbstract,DefaultStatisticsParser,DevInfoParser,SystemConfigParaParser,AlarmLogParser,GridProfileParser>{
public:
    HoymilesClass();
