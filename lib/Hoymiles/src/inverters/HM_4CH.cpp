...
static const byteAssign_t byteAssignment[] = {
    ...
    { TYPE_DC, CH3, FLD_UDC, UNIT_V, CALC_CH_UDC, CH2, CMD_CALC, false,true, 1 },
    ...
    { TYPE_AC, CH0, FLD_UAC, UNIT_V, 46, 2, 10, false,true, 1 },
    { TYPE_AC, CH0, FLD_IAC, UNIT_A, 54, 2, 100, false,true, 2 },
    { TYPE_AC, CH0, FLD_PAC, UNIT_W, 50, 2, 10, false,true, 1 },
    { TYPE_AC, CH0, FLD_Q, UNIT_VAR, 52, 2, 10, false,true, 1 },
    { TYPE_AC, CH0, FLD_F, UNIT_HZ, 48, 2, 100, false,true, 2 },
    { TYPE_AC, CH0, FLD_PF, UNIT_NONE, 56, 2, 1000, false,true, 3 },

    { TYPE_INV, CH0, FLD_T, UNIT_C, 58, 2, 10, true,true, 1 },
    { TYPE_INV, CH0, FLD_EVT_LOG, UNIT_NONE, 60, 2, 1, false,true, 0 },
